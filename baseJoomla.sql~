...
--
-- Servidor: localhost
-- Tiempo de generación: 02-10-2015 a las 08:43:44
...
--
-- Base de datos: 'baseJoomla'
--

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla 'o9og5_assets'
--

CREATE TABLE IF NOT EXISTS 'o9og5_assets' (
...
--
-- Volcado de datos para la tabla 'o9og5_assets'
--

INSERT INTO 'o9og5_assets' ('id', 'parent_id', 'lft', 'rgt', 'level', 'name', 'title', 'rules') VALUES
...
--
-- Estructura de tabla para la tabla 'o9og5_associations'
--

CREATE TABLE IF NOT EXISTS 'o9og5_associations' (
...
--
-- Estructura de tabla para la tabla 'o9og5_banners'
--

CREATE TABLE IF NOT EXISTS 'o9og5_banners' (
...
--
-- Estructura de tabla para la tabla 'o9og5_banner_clients'
--

CREATE TABLE IF NOT EXISTS 'o9og5_banner_clients' (
  'id' int(11) NOT NULL AUTO_INCREMENT,
  'name' varchar(255) NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla 'o9og5_banner_tracks'
--

CREATE TABLE IF NOT EXISTS 'o9og5_banner_tracks' (
...
--
-- Estructura de tabla para la tabla 'o9og5_categories'
--

CREATE TABLE IF NOT EXISTS 'o9og5_categories' (
  'id' int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla 'o9og5_categories'
--

INSERT INTO 'o9og5_categories' ('id', 'asset_id', 'parent_id', 'lft', 'rgt', 'level', 'path', 'extension', 'title', 'alias', 'note', 'description', 'published', 'checked_out', 'checked_out_time', 'access', 'params', 'metadesc', 'metakey', 'metadata', 'created_user_id', 'created_time', 'modified_user_id', 'modified_time', 'hits', 'language', 'version') VALUES
...
--
-- Estructura de tabla para la tabla 'o9og5_contact_details'
--

CREATE TABLE IF NOT EXISTS 'o9og5_contact_details' (
  'id' int(11) NOT NULL AUTO_INCREMENT,
  'name' varchar(255) NOT NULL DEFAULT '',
  'alias' varchar(255) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL DEFAULT '',
...
--
-- Estructura de tabla para la tabla 'o9og5_content'
--

CREATE TABLE IF NOT EXISTS 'o9og5_content' (
...
--
-- Estructura de tabla para la tabla 'o9og5_contentitem_tag_map'
--

CREATE TABLE IF NOT EXISTS 'o9og5_contentitem_tag_map' (
...
--
-- Estructura de tabla para la tabla 'o9og5_content_frontpage'
--

CREATE TABLE IF NOT EXISTS 'o9og5_content_frontpage' (
...
--
-- Estructura de tabla para la tabla 'o9og5_content_rating'
--

CREATE TABLE IF NOT EXISTS 'o9og5_content_rating' (
  'content_id' int(11) NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla 'o9og5_content_types'
--

CREATE TABLE IF NOT EXISTS 'o9og5_content_types' (
...
--
-- Volcado de datos para la tabla 'o9og5_content_types'
--

INSERT INTO 'o9og5_content_types' ('type_id', 'type_title', 'type_alias', 'table', 'rules', 'field_mappings', 'router', 'content_history_options') VALUES
...
--
-- Estructura de tabla para la tabla 'o9og5_core_log_searches'
--

CREATE TABLE IF NOT EXISTS 'o9og5_core_log_searches' (
...
--
-- Estructura de tabla para la tabla 'o9og5_extensions'
--

CREATE TABLE IF NOT EXISTS 'o9og5_extensions' (
...
--
-- Volcado de datos para la tabla 'o9og5_extensions'
--

INSERT INTO 'o9og5_extensions' ('extension_id', 'name', 'type', 'element', 'folder', 'client_id', 'enabled', 'access', 'protected', 'manifest_cache', 'params', 'custom_data', 'system_data', 'checked_out', 'checked_out_time', 'ordering', 'state') VALUES
...
(103, 'Joomla! Platform', 'library', 'joomla', '', 0, 1, 1, 1, '{"name":"Joomla! Platform","type":"library","creationDate":"2008","author":"Joomla! Project","copyright":"Copyright (C) 2005 - 2014 Open Source Matters. All rights reserved.","authorEmail":"admin@joomla.org","authorUrl":"http:\\/\\/www.joomla.org","version":"13.1","description":"LIB_JOOMLA_XML_DESCRIPTION","group":""}', '{"mediaversion":"94b008f2e5f7756343200e2fbb410231"}', '', '', 0, '0000-00-00 00:00:00', 0, 0),
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_filters'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_filters' (
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_links'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_links' (
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_links_terms0'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_links_terms0' (
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_links_terms1'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_links_terms1' (
  'link_id' int(10) unsigned NOT NULL,
  'term_id' int(10) unsigned NOT NULL,
  'weight' float unsigned NOT NULL,
  PRIMARY KEY ('link_id','term_id'),
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_links_terms2'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_links_terms2' (
  'link_id' int(10) unsigned NOT NULL,
  'term_id' int(10) unsigned NOT NULL,
  'weight' float unsigned NOT NULL,
  PRIMARY KEY ('link_id','term_id'),
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_links_terms3'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_links_terms3' (
  'link_id' int(10) unsigned NOT NULL,
  'term_id' int(10) unsigned NOT NULL,
  'weight' float unsigned NOT NULL,
  PRIMARY KEY ('link_id','term_id'),
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_links_terms4'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_links_terms4' (
  'link_id' int(10) unsigned NOT NULL,
  'term_id' int(10) unsigned NOT NULL,
  'weight' float unsigned NOT NULL,
  PRIMARY KEY ('link_id','term_id'),
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_links_terms5'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_links_terms5' (
  'link_id' int(10) unsigned NOT NULL,
  'term_id' int(10) unsigned NOT NULL,
  'weight' float unsigned NOT NULL,
  PRIMARY KEY ('link_id','term_id'),
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_links_terms6'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_links_terms6' (
  'link_id' int(10) unsigned NOT NULL,
  'term_id' int(10) unsigned NOT NULL,
  'weight' float unsigned NOT NULL,
  PRIMARY KEY ('link_id','term_id'),
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_links_terms7'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_links_terms7' (
  'link_id' int(10) unsigned NOT NULL,
  'term_id' int(10) unsigned NOT NULL,
  'weight' float unsigned NOT NULL,
  PRIMARY KEY ('link_id','term_id'),
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_links_terms8'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_links_terms8' (
  'link_id' int(10) unsigned NOT NULL,
  'term_id' int(10) unsigned NOT NULL,
  'weight' float unsigned NOT NULL,
  PRIMARY KEY ('link_id','term_id'),
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_links_terms9'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_links_terms9' (
  'link_id' int(10) unsigned NOT NULL,
  'term_id' int(10) unsigned NOT NULL,
  'weight' float unsigned NOT NULL,
  PRIMARY KEY ('link_id','term_id'),
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_links_termsa'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_links_termsa' (
  'link_id' int(10) unsigned NOT NULL,
  'term_id' int(10) unsigned NOT NULL,
  'weight' float unsigned NOT NULL,
  PRIMARY KEY ('link_id','term_id'),
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_links_termsb'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_links_termsb' (
  'link_id' int(10) unsigned NOT NULL,
  'term_id' int(10) unsigned NOT NULL,
  'weight' float unsigned NOT NULL,
  PRIMARY KEY ('link_id','term_id'),
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_links_termsc'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_links_termsc' (
  'link_id' int(10) unsigned NOT NULL,
  'term_id' int(10) unsigned NOT NULL,
  'weight' float unsigned NOT NULL,
  PRIMARY KEY ('link_id','term_id'),
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_links_termsd'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_links_termsd' (
  'link_id' int(10) unsigned NOT NULL,
  'term_id' int(10) unsigned NOT NULL,
  'weight' float unsigned NOT NULL,
  PRIMARY KEY ('link_id','term_id'),
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_links_termse'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_links_termse' (
  'link_id' int(10) unsigned NOT NULL,
  'term_id' int(10) unsigned NOT NULL,
  'weight' float unsigned NOT NULL,
  PRIMARY KEY ('link_id','term_id'),
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_links_termsf'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_links_termsf' (
  'link_id' int(10) unsigned NOT NULL,
  'term_id' int(10) unsigned NOT NULL,
  'weight' float unsigned NOT NULL,
  PRIMARY KEY ('link_id','term_id'),
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_taxonomy'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_taxonomy' (
  'id' int(10) unsigned NOT NULL AUTO_INCREMENT,
  'parent_id' int(10) unsigned NOT NULL DEFAULT '0',
  'title' varchar(255) NOT NULL,
...
--
-- Volcado de datos para la tabla 'o9og5_finder_taxonomy'
--

INSERT INTO 'o9og5_finder_taxonomy' ('id', 'parent_id', 'title', 'state', 'access', 'ordering') VALUES
(1, 0, 'ROOT', 0, 0, 0);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla 'o9og5_finder_taxonomy_map'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_taxonomy_map' (
  'link_id' int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_terms'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_terms' (
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_terms_common'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_terms_common' (
  'term' varchar(75) NOT NULL,
...
--
-- Volcado de datos para la tabla 'o9og5_finder_terms_common'
--

INSERT INTO 'o9og5_finder_terms_common' ('term', 'language') VALUES
('a', 'en'),
('about', 'en'),
('after', 'en'),
('ago', 'en'),
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_tokens'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_tokens' (
  'term' varchar(75) NOT NULL,
  'stem' varchar(75) NOT NULL,
  'common' tinyint(1) unsigned NOT NULL DEFAULT '0',
  'phrase' tinyint(1) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_tokens_aggregate'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_tokens_aggregate' (
  'term_id' int(10) unsigned NOT NULL,
...
--
-- Estructura de tabla para la tabla 'o9og5_finder_types'
--

CREATE TABLE IF NOT EXISTS 'o9og5_finder_types' (
  'id' int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla 'o9og5_languages'
--

CREATE TABLE IF NOT EXISTS 'o9og5_languages' (
...
--
-- Volcado de datos para la tabla 'o9og5_languages'
--

INSERT INTO 'o9og5_languages' ('lang_id', 'lang_code', 'title', 'title_native', 'sef', 'image', 'description', 'metakey', 'metadesc', 'sitename', 'published', 'access', 'ordering') VALUES
(1, 'en-GB', 'English (UK)', 'English (UK)', 'en', 'en', '', '', '', '', 1, 1, 1);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla 'o9og5_menu'
--

CREATE TABLE IF NOT EXISTS 'o9og5_menu' (
  'id' int(11) NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla 'o9og5_menu'
--

INSERT INTO 'o9og5_menu' ('id', 'menutype', 'title', 'alias', 'note', 'path', 'link', 'type', 'published', 'parent_id', 'level', 'component_id', 'checked_out', 'checked_out_time', 'browserNav', 'access', 'img', 'template_style_id', 'params', 'lft', 'rgt', 'home', 'language', 'client_id') VALUES
...
--
-- Estructura de tabla para la tabla 'o9og5_menu_types'
--

CREATE TABLE IF NOT EXISTS 'o9og5_menu_types' (
  'id' int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla 'o9og5_menu_types'
--

INSERT INTO 'o9og5_menu_types' ('id', 'menutype', 'title', 'description') VALUES
(1, 'mainmenu', 'Main Menu', 'The main menu for the site');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla 'o9og5_messages'
--

CREATE TABLE IF NOT EXISTS 'o9og5_messages' (
...
--
-- Estructura de tabla para la tabla 'o9og5_messages_cfg'
--

CREATE TABLE IF NOT EXISTS 'o9og5_messages_cfg' (
...
--
-- Estructura de tabla para la tabla 'o9og5_modules'
--

CREATE TABLE IF NOT EXISTS 'o9og5_modules' (
  'id' int(11) NOT NULL AUTO_INCREMENT,
  'asset_id' int(10) unsigned NOT NULL DEFAULT '0' COMMENT 'FK to the #__assets table.',
...
--
-- Volcado de datos para la tabla 'o9og5_modules'
--

INSERT INTO 'o9og5_modules' ('id', 'asset_id', 'title', 'note', 'content', 'ordering', 'position', 'checked_out', 'checked_out_time', 'publish_up', 'publish_down', 'published', 'module', 'access', 'showtitle', 'params', 'client_id', 'language') VALUES
...
--
-- Estructura de tabla para la tabla 'o9og5_modules_menu'
--

CREATE TABLE IF NOT EXISTS 'o9og5_modules_menu' (
...
--
-- Volcado de datos para la tabla 'o9og5_modules_menu'
--

INSERT INTO 'o9og5_modules_menu' ('moduleid', 'menuid') VALUES
(1, 0),
(2, 0),
(3, 0),
(4, 0),
...
--
-- Estructura de tabla para la tabla 'o9og5_newsfeeds'
--

CREATE TABLE IF NOT EXISTS 'o9og5_newsfeeds' (
  'catid' int(11) NOT NULL DEFAULT '0',
  'id' int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla 'o9og5_overrider'
--

CREATE TABLE IF NOT EXISTS 'o9og5_overrider' (
...
--
-- Estructura de tabla para la tabla 'o9og5_postinstall_messages'
--

CREATE TABLE IF NOT EXISTS 'o9og5_postinstall_messages' (
...
--
-- Volcado de datos para la tabla 'o9og5_postinstall_messages'
--

INSERT INTO 'o9og5_postinstall_messages' ('postinstall_message_id', 'extension_id', 'title_key', 'description_key', 'action_key', 'language_extension', 'language_client_id', 'type', 'action_file', 'action', 'condition_file', 'condition_method', 'version_introduced', 'enabled') VALUES
...
--
-- Estructura de tabla para la tabla 'o9og5_redirect_links'
--

CREATE TABLE IF NOT EXISTS 'o9og5_redirect_links' (
  'id' int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla 'o9og5_schemas'
--

CREATE TABLE IF NOT EXISTS 'o9og5_schemas' (
...
--
-- Volcado de datos para la tabla 'o9og5_schemas'
--

INSERT INTO 'o9og5_schemas' ('extension_id', 'version_id') VALUES
(700, '3.2.3-2014-02-20');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla 'o9og5_session'
--

CREATE TABLE IF NOT EXISTS 'o9og5_session' (
...
--
-- Volcado de datos para la tabla 'o9og5_session'
--

INSERT INTO 'o9og5_session' ('session_id', 'client_id', 'guest', 'time', 'data', 'userid', 'username') VALUES
('2mtbrps862u53rpfbavfc7ri25', 1, 0, '1443768185', '__default|a:8:{s:15:"session.counter";i:11;s:19:"session.timer.start";i:1443768163;s:18:"session.timer.last";i:1443768182;s:17:"session.timer.now";i:1443768184;s:22:"session.client.browser";s:102:"Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.85 Safari/537.36";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":2:{s:11:"application";O:8:"stdClass":1:{s:4:"lang";s:5:"en-GB";}s:13:"com_installer";O:8:"stdClass":2:{s:7:"message";s:0:"";s:17:"extension_message";s:0:"";}}}s:4:"user";O:5:"JUser":26:{s:9:"\\0\\0\\0isRoot";b:1;s:2:"id";s:3:"931";s:4:"name";s:10:"Super User";s:8:"username";s:6:"zubiri";s:5:"email";s:33:"jauzmediji14dw@ikzubirimanteo.com";s:8:"password";s:34:"$P$DStqT/CpIPNhMxZHQONEtd4TIa7GxG1";s:14:"password_clear";s:0:"";s:5:"block";s:1:"0";s:9:"sendEmail";s:1:"1";s:12:"registerDate";s:19:"2015-09-11 07:41:25";s:13:"lastvisitDate";s:19:"2015-09-11 07:41:42";s:10:"activation";s:1:"0";s:6:"params";s:0:"";s:6:"groups";a:1:{i:8;s:1:"8";}s:5:"guest";i:0;s:13:"lastResetTime";s:19:"0000-00-00 00:00:00";s:10:"resetCount";s:1:"0";s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:8;}s:14:"\\0\\0\\0_authLevels";a:5:{i:0;i:1;i:1;i:1;i:2;i:2;i:3;i:3;i:4;i:6;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;s:6:"otpKey";s:0:"";s:4:"otep";s:0:"";}s:13:"session.token";s:32:"8ee29403c2f3e1bccf80cf7ab021b939";}', 931, 'zubiri'),
('f7gonclju11u7hiu9e3gmk06j2', 0, 1, '1443768135', '__default|a:8:{s:15:"session.counter";i:1;s:19:"session.timer.start";i:1443768134;s:18:"session.timer.last";i:1443768134;s:17:"session.timer.now";i:1443768134;s:22:"session.client.browser";s:102:"Mozilla/5.0 (X11; Linux i686) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/45.0.2454.85 Safari/537.36";s:8:"registry";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:4:"user";O:5:"JUser":24:{s:9:"\\0\\0\\0isRoot";b:0;s:2:"id";i:0;s:4:"name";N;s:8:"username";N;s:5:"email";N;s:8:"password";N;s:14:"password_clear";s:0:"";s:5:"block";N;s:9:"sendEmail";i:0;s:12:"registerDate";N;s:13:"lastvisitDate";N;s:10:"activation";N;s:6:"params";N;s:6:"groups";a:1:{i:0;s:1:"9";}s:5:"guest";i:1;s:13:"lastResetTime";N;s:10:"resetCount";N;s:10:"\\0\\0\\0_params";O:9:"JRegistry":1:{s:7:"\\0\\0\\0data";O:8:"stdClass":0:{}}s:14:"\\0\\0\\0_authGroups";a:2:{i:0;i:1;i:1;i:9;}s:14:"\\0\\0\\0_authLevels";a:3:{i:0;i:1;i:1;i:1;i:2;i:5;}s:15:"\\0\\0\\0_authActions";N;s:12:"\\0\\0\\0_errorMsg";N;s:10:"\\0\\0\\0_errors";a:0:{}s:3:"aid";i:0;}s:13:"session.token";s:32:"df1c972193e9eaa94bc9296b0bf78c55";}', 0, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla 'o9og5_tags'
--

CREATE TABLE IF NOT EXISTS 'o9og5_tags' (
  'id' int(10) unsigned NOT NULL AUTO_INCREMENT,
  'parent_id' int(10) unsigned NOT NULL DEFAULT '0',
  'lft' int(11) NOT NULL DEFAULT '0',
  'rgt' int(11) NOT NULL DEFAULT '0',
...
--
-- Volcado de datos para la tabla 'o9og5_tags'
--

INSERT INTO 'o9og5_tags' ('id', 'parent_id', 'lft', 'rgt', 'level', 'path', 'title', 'alias', 'note', 'description', 'published', 'checked_out', 'checked_out_time', 'access', 'params', 'metadesc', 'metakey', 'metadata', 'created_user_id', 'created_time', 'created_by_alias', 'modified_user_id', 'modified_time', 'images', 'urls', 'hits', 'language', 'version', 'publish_up', 'publish_down') VALUES
(1, 0, 0, 1, 0, '', 'ROOT', 'root', '', '', 1, 0, '0000-00-00 00:00:00', 1, '', '', '', '', 0, '2011-01-01 00:00:01', '', 0, '0000-00-00 00:00:00', '', '', 0, '*', 1, '0000-00-00 00:00:00', '0000-00-00 00:00:00');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla 'o9og5_template_styles'
--

CREATE TABLE IF NOT EXISTS 'o9og5_template_styles' (
  'id' int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Volcado de datos para la tabla 'o9og5_template_styles'
--

INSERT INTO 'o9og5_template_styles' ('id', 'template', 'client_id', 'home', 'title', 'params') VALUES
...
--
-- Estructura de tabla para la tabla 'o9og5_ucm_base'
--

CREATE TABLE IF NOT EXISTS 'o9og5_ucm_base' (
...
--
-- Estructura de tabla para la tabla 'o9og5_ucm_content'
--

CREATE TABLE IF NOT EXISTS 'o9og5_ucm_content' (
...
--
-- Estructura de tabla para la tabla 'o9og5_ucm_history'
--

CREATE TABLE IF NOT EXISTS 'o9og5_ucm_history' (
...
--
-- Estructura de tabla para la tabla 'o9og5_updates'
--

CREATE TABLE IF NOT EXISTS 'o9og5_updates' (
...
--
-- Volcado de datos para la tabla 'o9og5_updates'
--

INSERT INTO 'o9og5_updates' ('update_id', 'update_site_id', 'extension_id', 'name', 'description', 'element', 'type', 'folder', 'client_id', 'version', 'data', 'detailsurl', 'infourl', 'extra_query') VALUES
(1, 1, 700, 'Joomla', '', 'joomla', 'file', '', 0, '3.4.4', '', 'http://update.joomla.org/core/sts/extension_sts.xml', '', ''),
...
(5, 3, 0, 'Flemish', '', 'pkg_nl-BE', 'package', '', 0, '3.4.4.1', '', 'http://update.joomla.org/language/details3/nl-BE_details.xml', '', ''),
(6, 3, 0, 'Chinese Traditional', '', 'pkg_zh-TW', 'package', '', 0, '3.4.2.1', '', 'http://update.joomla.org/language/details3/zh-TW_details.xml', '', ''),
(7, 3, 0, 'French', '', 'pkg_fr-FR', 'package', '', 0, '3.4.4.2', '', 'http://update.joomla.org/language/details3/fr-FR_details.xml', '', ''),
(8, 3, 0, 'Galician', '', 'pkg_gl-ES', 'package', '', 0, '3.3.1.2', '', 'http://update.joomla.org/language/details3/gl-ES_details.xml', '', ''),
(9, 3, 0, 'German', '', 'pkg_de-DE', 'package', '', 0, '3.4.4.1', '', 'http://update.joomla.org/language/details3/de-DE_details.xml', '', ''),
(10, 3, 0, 'Greek', '', 'pkg_el-GR', 'package', '', 0, '3.4.2.1', '', 'http://update.joomla.org/language/details3/el-GR_details.xml', '', ''),
(11, 3, 0, 'Japanese', '', 'pkg_ja-JP', 'package', '', 0, '3.4.4.1', '', 'http://update.joomla.org/language/details3/ja-JP_details.xml', '', ''),
...
(15, 3, 0, 'Hungarian', '', 'pkg_hu-HU', 'package', '', 0, '3.4.4.1', '', 'http://update.joomla.org/language/details3/hu-HU_details.xml', '', ''),
(16, 3, 0, 'Afrikaans', '', 'pkg_af-ZA', 'package', '', 0, '3.4.4.1', '', 'http://update.joomla.org/language/details3/af-ZA_details.xml', '', ''),
...
(27, 3, 0, 'Italian', '', 'pkg_it-IT', 'package', '', 0, '3.4.4.1', '', 'http://update.joomla.org/language/details3/it-IT_details.xml', '', ''),
(28, 3, 0, 'Khmer', '', 'pkg_km-KH', 'package', '', 0, '3.4.4.1', '', 'http://update.joomla.org/language/details3/km-KH_details.xml', '', ''),
...
(31, 3, 0, 'Macedonian', '', 'pkg_mk-MK', 'package', '', 0, '3.4.4.1', '', 'http://update.joomla.org/language/details3/mk-MK_details.xml', '', ''),
...
(34, 3, 0, 'Persian', '', 'pkg_fa-IR', 'package', '', 0, '3.4.4.1', '', 'http://update.joomla.org/language/details3/fa-IR_details.xml', '', ''),
...
(38, 3, 0, 'Slovak', '', 'pkg_sk-SK', 'package', '', 0, '3.4.4.2', '', 'http://update.joomla.org/language/details3/sk-SK_details.xml', '', ''),
...
(41, 3, 0, 'Tamil', '', 'pkg_ta-IN', 'package', '', 0, '3.4.4.1', '', 'http://update.joomla.org/language/details3/ta-IN_details.xml', '', ''),
...
(51, 3, 0, 'Bosnian', '', 'pkg_bs-BA', 'package', '', 0, '3.4.4.1', '', 'http://update.joomla.org/language/details3/bs-BA_details.xml', '', ''),
...
(56, 3, 0, 'Swahili', '', 'pkg_sw-KE', 'package', '', 0, '3.4.4.1', '', 'http://update.joomla.org/language/details3/sw-KE_details.xml', '', ''),
...
--
-- Estructura de tabla para la tabla 'o9og5_update_sites'
--

CREATE TABLE IF NOT EXISTS 'o9og5_update_sites' (
...
--
-- Volcado de datos para la tabla 'o9og5_update_sites'
--

INSERT INTO 'o9og5_update_sites' ('update_site_id', 'name', 'type', 'location', 'enabled', 'last_check_timestamp', 'extra_query') VALUES
(1, 'Joomla Core', 'collection', 'http://update.joomla.org/core/list.xml', 1, 1443768184, ''),
(2, 'Joomla Extension Directory', 'collection', 'http://update.joomla.org/jed/list.xml', 1, 1443768184, ''),
(3, 'Accredited Joomla! Translations', 'collection', 'http://update.joomla.org/language/translationlist_3.xml', 1, 1443768184, '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla 'o9og5_update_sites_extensions'
--

CREATE TABLE IF NOT EXISTS 'o9og5_update_sites_extensions' (
...
--
-- Volcado de datos para la tabla 'o9og5_update_sites_extensions'
--

INSERT INTO 'o9og5_update_sites_extensions' ('update_site_id', 'extension_id') VALUES
(1, 700),
(2, 700),
(3, 600);
...
--
-- Estructura de tabla para la tabla 'o9og5_usergroups'
--

CREATE TABLE IF NOT EXISTS 'o9og5_usergroups' (
  'id' int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
...
--
-- Volcado de datos para la tabla 'o9og5_usergroups'
--

INSERT INTO 'o9og5_usergroups' ('id', 'parent_id', 'lft', 'rgt', 'title') VALUES
(1, 0, 1, 18, 'Public'),
(2, 1, 8, 15, 'Registered'),
(3, 2, 9, 14, 'Author'),
(4, 3, 10, 13, 'Editor'),
...
--
-- Estructura de tabla para la tabla 'o9og5_users'
--

CREATE TABLE IF NOT EXISTS 'o9og5_users' (
  'id' int(11) NOT NULL AUTO_INCREMENT,
  'name' varchar(255) NOT NULL DEFAULT '',
...
--
-- Volcado de datos para la tabla 'o9og5_users'
--

INSERT INTO 'o9og5_users' ('id', 'name', 'username', 'email', 'password', 'block', 'sendEmail', 'registerDate', 'lastvisitDate', 'activation', 'params', 'lastResetTime', 'resetCount', 'otpKey', 'otep') VALUES
(931, 'Super User', 'zubiri', 'jauzmediji14dw@ikzubirimanteo.com', '$P$DStqT/CpIPNhMxZHQONEtd4TIa7GxG1', 0, 1, '2015-09-11 07:41:25', '2015-10-02 06:43:00', '0', '', '0000-00-00 00:00:00', 0, '', '');

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla 'o9og5_user_keys'
--

CREATE TABLE IF NOT EXISTS 'o9og5_user_keys' (
  'id' int(10) unsigned NOT NULL AUTO_INCREMENT,
...
--
-- Estructura de tabla para la tabla 'o9og5_user_notes'
--

CREATE TABLE IF NOT EXISTS 'o9og5_user_notes' (
  'id' int(10) unsigned NOT NULL AUTO_INCREMENT,
  'user_id' int(10) unsigned NOT NULL DEFAULT '0',
  'catid' int(10) unsigned NOT NULL DEFAULT '0',
...
--
-- Estructura de tabla para la tabla 'o9og5_user_profiles'
--

CREATE TABLE IF NOT EXISTS 'o9og5_user_profiles' (
...
--
-- Estructura de tabla para la tabla 'o9og5_user_usergroup_map'
--

CREATE TABLE IF NOT EXISTS 'o9og5_user_usergroup_map' (
...
--
-- Volcado de datos para la tabla 'o9og5_user_usergroup_map'
--

INSERT INTO 'o9og5_user_usergroup_map' ('user_id', 'group_id') VALUES
(931, 8);

-- --------------------------------------------------------

--
-- Estructura de tabla para la tabla 'o9og5_viewlevels'
--

CREATE TABLE IF NOT EXISTS 'o9og5_viewlevels' (
  'id' int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT 'Primary Key',
  'title' varchar(100) NOT NULL DEFAULT '',
  'ordering' int(11) NOT NULL DEFAULT '0',
  'rules' varchar(5120) NOT NULL COMMENT 'JSON encoded access control.',
...
--
-- Volcado de datos para la tabla 'o9og5_viewlevels'
--

INSERT INTO 'o9og5_viewlevels' ('id', 'title', 'ordering', 'rules') VALUES
(1, 'Public', 0, '[1]'),
...
--
-- Estructura de tabla para la tabla 'o9og5_weblinks'
--

CREATE TABLE IF NOT EXISTS 'o9og5_weblinks' (
  'id' int(10) unsigned NOT NULL AUTO_INCREMENT,
  'catid' int(11) NOT NULL DEFAULT '0',
